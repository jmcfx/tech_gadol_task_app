...
switch (_that) {
case _ProductModel():
return $default(_that.id,_that.title,_that.description,_that.price,_that.discountPercentage,_that.rating,_that.stock,_that.brand,_that.category,_that.thumbnail,_that.images);}
}
...
class _ProductModel implements ProductModel {
  const _ProductModel({this.id = 0, this.title = '', this.description = '', this.price = 0.0, this.discountPercentage = 0.0, this.rating = 0.0, this.stock = 0, this.brand, this.category = '', this.thumbnail = '', final  List<String> images = const []}): _images = images;
